...
public class ArrayForEach {
	...
	public static void main(String[] args) {
		...
		/*
		 * [표현법] for(순차적으로 접글할 값을 담을 변수 선언: 내가 순차적으로 접근할 배열명 또는 컬렉션명을 적는다. ){ 반복적으로 실행할
		 * 내용 }
		 * 
		...
		/*
		 * for(int i = 0; i<phones.length;i++) { if(phones[i].getName().equals(name)) {
		 * System.out.println("사용자님꼐서 입력하신 " + name + "의 가격은 " + phones[i].getPrice() +
		 * "입니다. "); break;//찾고자 하는 매개체를 찾은 뒤, 다시말해 낭비스런 프로세스를 진행하지 않는다. 메모리 효율 상승?
		 */
